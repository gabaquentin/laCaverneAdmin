...
foreach($listecategorie as $row){
	...
	if($_GET['reference'] == $row['referencee'])
	{
									$nom=$row['nomcat'];
									$reference=$row['referencee'];
	}
}
}
else
        ...
        <div class="row tm-mt-big">
            <div class="col-xl-8 col-lg-10 col-md-12 col-sm-12">
                <div class="bg-white tm-block">
                    <div class="row">
                        <div class="col-12">
                            <h2 class="tm-block-title d-inline-block">Modifier la categorie</h2>
                        </div>
                    </div>
                    <div class="row mt-4 tm-edit-product-row">
                        <div class="col-xl-7 col-lg-7 col-md-12">
                            <form action="views/modifiercategorie.php?reference=<?php echo $_GET['reference']; ?>&amp;nom=<?php echo $_GET['nom']; ?>" method="post" class="tm-edit-product-form">
